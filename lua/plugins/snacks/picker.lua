...
return {
	{
		...
		opts = {
			picker = {
				sources = {
					...
					last_dirs = {
						finder = function()
							local path = vim.fn.stdpath("state") .. "/last_dirs.txt"
							local lines = vim.fn.readfile(path)
							return require("snacks.finders").new_table({ results = lines })
						end,
						format = "%s",
						prompt = "Projects",
					},
		...
		keys = {
			...
			},
			{
				"<leader>pd",
				function()
					Snacks.picker.smart({ title = "Projects", finder = "last_dirs", prompt = "Projects" })
				end,
				desc = "Switch Project",
			},
			{
